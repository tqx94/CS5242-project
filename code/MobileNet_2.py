...
def main():
    ...
    for model_name in [ 'MobileNet_512_256_batch_4',
        ...
        if model_name == 'MobileNet_512_256_batch_4':
            ...
            batch_size = 4
            model = MobileNet_512_256(img_size)
            model.fit(train_generator.flow(Xtrain,ytrain,batch_size=batch_size),
                                ...
                                callbacks = [reduce_lr,ModelCheckpoint(filepath=ckp_path, monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')]
                               )
        ...
        elif model_name == 'MobileNet_512_batch_16':
            img_size = 512
            reduce_lr = ReduceLROnPlateau(monitor="val_loss", factor=0.5, patience=10,
                                          verbose=0, mode="auto", epsilon=1e-04, cooldown=0,
                                          min_lr=0.000001)
